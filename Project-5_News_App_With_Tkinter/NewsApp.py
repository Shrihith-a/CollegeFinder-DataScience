...
import requests
from Shri_Weather_App import WeatherApp
...
class NewsApp:
    def __init__(self,app):
        self.app = app
        self.app.title("NewsApp by Shri")
    ...
    def NewsArea(self, event):
        ...
        apiKey = 'a925583c5614406993cb771edde9f597'
...
pic = PhotoImage(file='C:/Users/Shrih/OneDrive/Documents/Courses/College_Finder/Projects/Project-5_News_App_With_Tkinter/NewsIcon.png')
